...
describe('customer', () => {
  ...
  describe('#loadFile()', () => {
    ...
    it('should throw an error when file does not exists', () => {
      expect(customer.loadFile('data/customers-non-existing.json')).to.be.rejected;
    });
  });
  ...
  describe('#loadCustomers()', () => {
    ...
    it('should throw an error when file does not exists', () => {
      expect(customer.loadCustomers('data/customers-non-existing.json')).to.be.rejected;
    });

    it('should throw an error when an user has a missing property', () => {
      expect(customer.loadCustomers('data/customers-missing-property.json')).to.be.rejected;
    });

    it('should throw an error when an user has a wrong coordinate', () => {
      expect(customer.loadCustomers('data/customers-wrong-lat.json')).to.be.rejected;
    });

    it('should throw an error when an user has a wrong name', () => {
      expect(customer.loadCustomers('data/customers-wrong-name.json')).to.be.rejected;
    });

    it('should throw an error when an user has a wrong user id', () => {
      expect(customer.loadCustomers('data/customers-wrong-userid.json')).to.be.rejected;
    });
  });
});
